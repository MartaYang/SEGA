...
_CUB_FS_DATASET_DIR = '/data/FSLDatasets/cub'
...
class CUB_FS(data.Dataset):
    def __init__(self, phase='train', do_not_use_random_transf=False):

        assert(phase=='train' or phase=='val' or phase=='test')
        self.phase = phase
        self.name = 'CUB_FS_' + phase

        print('Loading CUB-FS dataset - phase {0}'.format(phase))
...
class CUB_FS_cutout(data.Dataset):
    def __init__(self, phase='train', do_not_use_random_transf=False):
